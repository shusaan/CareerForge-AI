...
function ToastProviderWrapper({ children }: { children: React.ReactNode }) {
  ...
  const toast = useCallback((data: Omit<ToastData, "id">) => {
    ...
    setToasts((prev) => [...prev, { ...data, id }].slice(-MAX_TOASTS));
    setTimeout(() => {
